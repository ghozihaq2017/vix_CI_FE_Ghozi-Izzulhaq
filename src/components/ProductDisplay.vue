...
<template>
  <div class="product-page">
    ...
    <div
      ...
      :class="!isProductAvailable ? 'bg-grey' : this.isWomenClothing ? 'bg-pink' : 'bg-blue'"
    >
      ...
      <div class="card">
        ...
        <div v-else class="product-container">
          ...
          <div class="detail-product">
            <div class="top-card">
              <h2
                v-if="productData && productData.title"
                class="title"
                :class="isMenClothing ? 'text-navy' : 'text-purple'"
              >
                {{ productData.title }}
              </h2>
              <div class="category">
                ...
                <div class="rating">
                  <span v-if="productData && productData.rating">{{
                  ...
                  <div class="circles-rate">
                    <span
                      class="circle"
                      :class="
                        this.productData.rating.rate < 0.5
                          ? isMenClothing
                            ? 'bgrd-white-navy'
                            : 'bgrd-white-purple'
                          : isMenClothing
                    ...
                    <span
                      class="circle"
                      :class="
                        this.productData.rating.rate < 1.5
                          ? isMenClothing
                            ? 'bgrd-white-navy'
                            : 'bgrd-white-purple'
                          : isMenClothing
                    ...
                    <span
                      class="circle"
                      :class="
                        this.productData.rating.rate < 2.5
                          ? isMenClothing
                            ? 'bgrd-white-navy'
                            : 'bgrd-white-purple'
                          : isMenClothing
                    ...
                    <span
                      class="circle"
                      :class="
                        this.productData.rating.rate < 3.5
                          ? isMenClothing
                            ? 'bgrd-white-navy'
                            : 'bgrd-white-purple'
                          : isMenClothing
                    ...
                    <span
                      class="circle"
                      :class="
                        this.productData.rating.rate < 4.5
                          ? isMenClothing
                            ? 'bgrd-white-navy'
                            : 'bgrd-white-purple'
                          : isMenClothing
            ...
            <div class="bottom-card">
              <span
                v-if="productData && productData.price"
                class="price"
                :class="isMenClothing ? 'text-navy' : 'text-purple'"
                >$ {{ productData.price }}</span
              >
              <div class="buttons">
                <button class="btn-buy" :class="isMenClothing ? 'btn-navy' : 'btn-purple'">
                  Buy now
                </button>
                <button
                  @click="this.displayNextProduct"
                  class="btn-next"
                  :class="isMenClothing ? 'btn-navy-bdr' : 'btn-purple-bdr'"
                >
                  Next product
                </button>
              </div>
